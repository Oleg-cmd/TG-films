// components/ui/MatchAnimation.tsx
"use client";
...
const MatchAnimation = observer(() => {
  const matchedMovie = lobbyStore.matchedMovie;
  return (
    <motion.div
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        {matchedMovie && (
          <div className='mt-8 flex flex-col justify-center items-center'>
            ...
            <div className='text-white font-bold text-2xl text-center mt-2'>
              {matchedMovie.releaseYear}
            </div>
          </div>
        )}
      </div>
